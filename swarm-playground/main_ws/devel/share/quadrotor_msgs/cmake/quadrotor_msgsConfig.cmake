...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /home/tomoking/drone/EGO-Planner-v2/swarm-playground/main_ws/src/Utils/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /home/tomoking/drone/EGO-Planner-v2/swarm-playground/main_ws/devel)
  ...
  set(quadrotor_msgs_INSTALL_PREFIX /home/tomoking/drone/EGO-Planner-v2/swarm-playground/main_ws/install)
...
if(NOT "/home/tomoking/drone/EGO-Planner-v2/swarm-playground/main_ws/devel/include " STREQUAL " ")
  set(quadrotor_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/tomoking/drone/EGO-Planner-v2/swarm-playground/main_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tomoking/drone/EGO-Planner-v2/swarm-playground/main_ws/src/Utils/quadrotor_msgs/${idir}'.  ${_report}")
    endif()
