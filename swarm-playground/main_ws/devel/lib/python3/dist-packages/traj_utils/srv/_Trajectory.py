...
"""autogenerated by genpy from traj_utils/TrajectoryRequest.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryRequest(genpy.Message):
  _md5sum = "7bc31786bdfd00a184cc37e4fc7d82f0"
  _type = "traj_utils/TrajectoryRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """quadrotor_msgs/GoalSet goalset
...
"""
  __slots__ = ['goalset']
  _slot_types = ['quadrotor_msgs/GoalSet']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goalset is None:
        self.goalset = quadrotor_msgs.msg.GoalSet()
    else:
      self.goalset = quadrotor_msgs.msg.GoalSet()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.goalset.drone_id
      buff.write(_get_struct_h().pack(_x))
      buff.write(_get_struct_3f().pack(*self.goalset.goal))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goalset.drone_id,) = _get_struct_h().unpack(str[start:end])
      start = end
      end += 12
      self.goalset.goal = _get_struct_3f().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      _x = self.goalset.drone_id
      buff.write(_get_struct_h().pack(_x))
      buff.write(self.goalset.goal.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.goalset.goal = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
def _get_struct_h():
    ...
    return _struct_h
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from traj_utils/TrajectoryResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class TrajectoryResponse(genpy.Message):
  ...
  _type = "traj_utils/TrajectoryResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class Trajectory(object):
  _type          = 'traj_utils/Trajectory'
  _md5sum = 'daf3e1c19fb97921316eec6ffd7ff9ed'
